	...
	public AdminLogin() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(name.equals("admin")&&password.equals("admin123")){
				...
				frame.dispose();
			}if(name.equals("suraj")&&password.equals("suraj123")){
				AdminSuccess.main(new String[]{});
				frame.dispose();
			}else{
		...
		JLabel lab = new JLabel("E-Library  Management System ");
		lab.setForeground(Color.WHITE);
		lab.setFont(new Font("Chilanka", Font.BOLD, 37));
		lab.setBounds(107, 31, 572, 63);
		panel_2.add(lab);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("image/img2.jpg"));
		lblNewLabel_1.setBounds(-247, 11, 1521, 657);
